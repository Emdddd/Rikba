...
export default function DownloadPage() {
  return (
    <div className="min-h-[85vh] bg-slate-50/50 flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full border border-slate-200/80 bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50">
        
        {/* Title & Description */}
        <h1 className="text-3xl font-extrabold mb-3 text-slate-900 tracking-tight">
          Download Rikba App
        </h1>
        ...
        <div className="flex flex-col gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 rounded-2xl transition-all duration-200 shadow-md shadow-blue-500/25 active:scale-[0.98]"
          >
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider opacity-90 font-medium">GET IT ON</span>
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider opacity-90 font-medium">Download on the</span>

...
export default function DownloadPage() {
  return (
    <div className="min-h-[85vh] bg-background flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full border border-border bg-card rounded-3xl p-8 shadow-xl">
        ...
        <div className="flex flex-col gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-primary hover:opacity-90 text-primary-foreground px-6 py-3.5 rounded-2xl transition-all duration-200 shadow-md active:scale-[0.98]"
          >

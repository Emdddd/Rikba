...
export default function DownloadPage() {
  return (
    <div className="min-h-[80vh] bg-background flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full border border-border bg-card rounded-2xl p-8 shadow-lg">
        <h1 className="text-3xl font-bold mb-3 text-foreground">Download Rikba App</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-black text-white dark:bg-white dark:text-black px-5 py-3 rounded-xl transition-transform hover:scale-105"
          >
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider opacity-80">GET IT ON</span>
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider opacity-80">Download on the</span>

...
export default function DownloadPage() {
  return (
    <div className="min-h-[85vh] bg-slate-50/50 flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full border border-sky-100 bg-white rounded-3xl p-8 shadow-xl shadow-sky-100/40">
        ...
        <div className="flex flex-col gap-4 justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 bg-sky-500 hover:bg-sky-600 text-white px-6 py-3.5 rounded-2xl transition-all duration-200 shadow-md shadow-sky-500/20 active:scale-[0.98]"
          >

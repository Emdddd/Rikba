...
export default function DownloadPage() {
  return (
    <div className="min-h-[85vh] bg-background flex flex-col items-center justify-center p-6 text-center gap-8 py-12">
      ...
      <div className="max-w-md w-full border border-sky-500/20 bg-card rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <h2 className="text-3xl font-extrabold mb-3 text-foreground tracking-tight">
          Drive with us, <span className="text-sky-500">earn better.</span>
        </h2>
        <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
          Download the Rikba Driver app, sign up, and keep up to 92% of your ride earnings.
        </p>

        {/* Buttons Container */}
        <div className="flex flex-col gap-4 justify-center">

          {/* App Store Button (Driver) */}
          <a
          ...
          >
            ...
            <div className="text-left text-black">
              <span className="block text-[9px] uppercase tracking-wider font-extrabold opacity-80 text-black">Download Driver app on</span>
              <span className="block text-base font-extrabold leading-tight text-black">App Store</span>
            </div>
          </a>
          
          {/* Google Play Button (Driver) */}
          <a
          ...
          >
            ...
            <div className="text-left text-black">
              <span className="block text-[9px] uppercase tracking-wider font-extrabold opacity-80 text-black">GET Driver app ON</span>
              <span className="block text-base font-extrabold leading-tight text-black">Google Play</span>
            </div>
          </a>

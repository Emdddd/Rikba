        ...
        <div className="flex flex-col gap-4 justify-center">
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider font-extrabold opacity-80">GET IT ON</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3.5 border border-sky-500/30 bg-sky-500/10 hover:bg-sky-500/20 text-sky-400 px-6 py-3.5 rounded-2xl transition-all duration-300 shadow-md active:scale-[0.98]"
          >
            <svg className="w-6 h-6 fill-current shrink-0 text-sky-400" viewBox="0 0 24 24">
            ...
            <div className="text-left">
              <span className="block text-[9px] uppercase tracking-wider font-semibold opacity-80">Download on the</span>

    ...
    <div className={`absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden ${className}`}>
      <div className="animate-malta-float relative w-[320px] h-[384px] md:w-[500px] md:h-[600px]">
        ...
        >
          ...
          {/* Small inner contour paths (hills) */}
          <path
            d="M220 200 C230 195, 250 200, 260 210 C270 220, 275 235, 260 240"
            stroke="currentColor"
            strokeWidth="0.8"
          ...
          />
          <path
            d="M300 300 C310 290, 330 295, 340 310"
            stroke="currentColor"
            strokeWidth="0.8"
            className="text-primary"
            fill="none"
          ...
          {/* Optional location pulse dots */}
          <circle cx="310" cy="250" r="3" className="text-primary fill-current animate-ping" style={{ animationDuration: "3s" }} />
          <circle cx="310" cy="250" r="1.5" className="text-primary fill-current" />

          <circle cx="210" cy="80" r="2.5" className="text-primary fill-current animate-ping" style={{ animationDuration: "4s", animationDelay: "1s" }} />
          <circle cx="210" cy="80" r="1" className="text-primary fill-current" />

          <circle cx="350" cy="320" r="2.5" className="text-primary fill-current animate-ping" style={{ animationDuration: "3.5s", animationDelay: "2s" }} />
          <circle cx="350" cy="320" r="1" className="text-primary fill-current" />

    ...
    <section className="py-20 md:py-32 border-t border-border">
      <div className="mx-auto max-w-6xl px-5">
        <AnimateOnScroll animation="scale-in">
          <div className="rounded-3xl border border-border bg-card p-8 md:p-14 text-center relative overflow-hidden min-h-[400px] md:min-h-[480px] flex flex-col items-center justify-center">
            {/* Animated Malta Map Background */}
            <MaltaMap />

            {/* Gradient overlay for readability */}
            <div className="absolute inset-0 bg-gradient-to-b from-card/60 via-card/40 to-card/70 pointer-events-none" />
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-card-foreground text-balance leading-tight">
            ...
            {/* Animated car driving across bottom */}
